...
dnl Copyright (C) 1994, 1999 Free Software Foundation, Inc.
dnl
...
AC_DEFUN(AM_CYGWIN32, [indir([AC_CYGWIN32])])dnl
AC_DEFUN(AM_EXEEXT, [indir([AC_EXEEXT])])dnl
AC_DEFUN(AM_FUNC_FNMATCH, [indir([AC_FUNC_FNMATCH])])dnl
AC_DEFUN(AM_FUNC_MKTIME, [indir([AC_FUNC_MKTIME])])dnl
dnl We cannot do this, because in libtool.m4 yet they provide
dnl this update.  Some solution is needed.
dnl AC_DEFUN(AM_PROG_LIBTOOL, [indir([AC_PROG_LIBTOOL])])dnl
AC_DEFUN(AM_MINGW32, [indir([AC_MINGW32])])dnl
AC_DEFUN(AM_PROG_INSTALL, [indir([AC_PROG_INSTALL])])dnl
AC_DEFUN(fp_FUNC_FNMATCH, [indir([AC_FUNC_FNMATCH])])dnl
